...
public class PetContract {
    ...
    public static final class PetEntry implements BaseColumns {
        ...
        public static final String COLUMN_BREED_TYPE = "TEXT";

        public static final String COLUMN_GENDER_NAME = "gender";
        public static final String COLUMN_GENDER_TYPE = "INTEGER";

        public static final String COLUMN_WEIGHT_NAME = "weight";
        public static final String COLUMN_WEIGHT_TYPE = "INTEGER";
